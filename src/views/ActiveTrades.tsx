...
import { Target, TrendingDown, TrendingUp, AlertCircle, Percent } from 'lucide-react';
                        ...
                        <table className="w-full text-left border-collapse whitespace-nowrap">
                            <thead>
                                <tr className="bg-white/5 text-xs text-slate-400 uppercase tracking-wider font-medium">
                                    ...
                                    <th className="px-6 py-4 border-b border-white/5">ML Confidence</th>
                                    <th className="px-6 py-4 border-b border-white/5">Opened At</th>
                                        ...
                                        <tr key={t.id} className="hover:bg-white/5 transition-colors group">
                                            ...
                                            <td className="px-6 py-4 font-mono">
                                                <span className="flex items-center gap-1 text-primary">
                                                    <Percent size={12} /> {t.ml_confidence ? (t.ml_confidence * 100).toFixed(0) : '--'}%
                                                </span>
                                            </td>
